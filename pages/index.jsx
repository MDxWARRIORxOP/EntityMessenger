        ...
        <div className={styles.mainInHome}>
          <>
            ...
            <div className={styles.text}>
              ...
              <h2>
                Do you seriously still use Skype or Zoom? <br /> They worked
                well in 2018, but in 2022, <br /> it&apos;s time to upgrade to
                Entity Messenger!
              </h2>
              <br />
              <Link href="/chat">
        ...
        <div className={styles.benefits}>
          <>
            ...
            <ul>
              <li>
                <h2>
                  Create your own spaceship with as many rooms as you want.
                </h2>
              </li>
              <li>
